...
<body>
    ...
    <div class="popup-overlay" id="successPopup">
        <div class="popup-content">
            ...
            <p>Your company account has been successfully created. You can now login and start posting jobs.</p>
        ...
        <div class="right-panel">
            ...
            <form id="signupForm" method="POST">
                ...
                <div class="login-text">
                    Already have a Company? <a href="loginScreen.php">Login</a>
                </div>
            </form>
        </div>
    ...
    <script>
        ...
        document.getElementById("signupForm").addEventListener("submit", function(e) {
            ...
            if (name.length < 2) {
                setError("err-firstname", "Company name must be at least 2 characters");
                valid = false;
            }
